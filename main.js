...
burger.addEventListener('click', function() { 
  let overflowWidth = window.innerWidth - document.documentElement.clientWidth;

  nav.classList.toggle('active');
  hidden.classList.toggle('active');
  html.classList.toggle('lock');
  
  html.style.paddingRight = (html.classList.contains('lock')) ? overflowWidth + 'px' : '0';
  header.style.paddingRight = (html.classList.contains('lock')) ? overflowWidth + 'px' : '0';
...
for (let mark of marks) {
  ...
  choice.addEventListener('click', function() {
    ...
    html.style.paddingRight = overflowWidth + 'px';
